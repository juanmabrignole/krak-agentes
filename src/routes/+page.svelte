...
<section class="px-4 pt-6 pb-0 sm:pb-8 h-fit sm:min-h-[100svh] text-white grid place-content-center text-center bg-[url(/hero-1.png)] bg-right bg-cover">

	<div class="sm:drop-shadow-2xl z-10">
		<h1 class="text-5xl lg:text-6xl font-bold mb-4 mt-24">Convertite en un Krak.</h1>
		<p class="mb-8 text-balance">Unite a nosotros y transformá tu carrera profesional.</p>
		<a href="#contacto" class="block -mb-8 bg-red-600 sm:bg-red-500 hover:bg-black text-white uppercase rounded-full w-fit mx-auto py-6 px-14 font-bold text-sm"> Quiero empezar </a>
	</div>
...
<section class="bg-red-500 text-white" id="banner-1">
	<div class="mx-auto pt-16 sm:pt-0 w-full max-w-6xl grid lg:grid-cols-2 px-4">
		<h2 class="text-2xl lg:text-5xl font-semibold lg:font-medium py-6 sm:py-20 text-balance">Forma parte de un<br> equipo de bienes<br> raíces al servicio de<br> tu desarrollo personal<br> y profesional</h2>
		<div class="relative h-80 lg:h-full block w-full">
			<img class="object-contain absolute w-fit h-96 bottom-0 inset-x-0 mx-auto lg:left-0" src="/svg/circle.svg" alt="" />
			<img class="object-contain object-bottom absolute w-fit h-72 lg:h-80 bottom-0 inset-x-0 mx-auto" src="/woman.png" alt="woman" />
		</div>
	</div>
</section>
...
<section class="py-20">
	<div class="mx-auto w-full max-w-6xl">
		<h2 class="text-4xl lg:text-5xl font-semibold text-red-500 text-center mb-12 text-balance">Ventajas de ser un Krak</h2>
		<div bind:this={featuresCarousel} class="overflow-x-scroll flex gap-4 px-[calc((100vw-16rem)/2)] lg:px-0 no-scrollbar lg:grid lg:grid-cols-3 lg:place-content-center mb-8">
			<div class="group overflow-hidden relative hover:bg-red-500 rounded-3xl min-w-64 px-4 pb-16 lg:pb-10 lg:px-10 p-10 hover:text-white transition-all hover:border-red-500 group border-2 border-gray-100">
				...
				<p class="group-hover:translate-y-64 transition-all text-center mx-auto text-lg">Visibilidad en los portales inmobiliarios más importantes</p>
...
<section class="bg-white py-20 relative">
	...
	<p class="max-w-xl mx-auto w-fit lg:text-center text-pretty px-6 lg:text-pretty mb-16 text-base sm:text-lg text-gray-600">Estos son nuestros valores para el trabajo y para la vida, con estos valores nos guiamos y le damos la bienvenida a cada uno que se incorpore a la experiencia de ser parte de Krak.</p>
	...
	<div
		...
		class="overflow-x-scroll flex gap-4 px-4 md:px-[calc((100vw-40rem)/2)] lg:px-[calc((100vw-60rem)/2)] no-scrollbar">
		<div class="bg-red-500 text-white rounded-3xl min-w-[calc(100vw-4rem)] sm:min-w-[calc(100vw-16rem)] md:min-w-80 p-8 pt-7">
...
<section class="bg-gray-100 py-20 w-full">
	...
	<ul class="flex flex-col gap-2 max-w-xs lg:max-w-4xl mx-auto px-4">
		<li>
			<label class="flex flex-col bg-red-500 text-white py-4 px-12 rounded-xl has-[:checked]:bg-red-50 group has-[:checked]:text-black hover:cursor-pointer relative">
				...
				<span class="absolute top-4 right-4 sm:right-10 icon-[tabler--chevron-down] text-3xl peer-checked:rotate-180"></span>
...
<section class="pt-20 pb-24 bg-[#313B51]" id="contacto">
	...
	<form on:submit|preventDefault={handleForm} class="max-w-xs group lg:max-w-4xl w-full mx-auto rounded-3xl relative px-4">
		<div class="group-then:-translate-x-full group-catch:translate-x-full group-then:opacity-0 group-catch:opacity-0 transition-all">
			...
			<div class="grid lg:grid-cols-2 has-[:disabled]:grid-cols-1 gap-4 lg:gap-2 mb-4 group-await:opacity-50">

				<div class="flex-1 pl-12 pr-8 lg:pr-12 gap-y-3 py-4 bg-white rounded-xl grid grid-cols-[auto_1fr] sm:flex justify-between items-center gap-8 lg:gap-12">
					<span class="row-span-2 mb-auto flex-1">Experiencia</span>
				...
				<label class="text-gray-500 relative flex has-[:disabled]:max-h-0 has-[:disabled]:max-w-0 overflow-hidden max-w-screen-sm max-h-16 transition-all">
					<input disabled class="rounded-xl peer pt-7 pb-2 pl-12 px-4 w-full font-bold" type="number" placeholder=" " maxlength="255" name="years"> 
